...
export default function ClaimOfferThanks({ page }) {
            ...
            <div className="container">
              <div className="contactWrap">
                <article>
                  <h1>Thank You</h1>
                  <p>
                    Your form was successfully submitted. Someone from our
                    office will be responding to you shortly. If you don&apos;t
                    hear back from us within the next 24 hours, please check
                    your junk mail to ensure we weren&apos;t flagged by the spam
                    filter.
                    <div>
                      <Link href="/">
